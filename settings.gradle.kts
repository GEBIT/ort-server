...
include(":components:dependency-graph:api-model")
include(":components:dependency-graph:backend")
include(":components:infrastructure-services:api-model")
include(":components:infrastructure-services:backend")
include(":components:license-findings:api-model")
include(":components:license-findings:backend")
...
include(":components:server-settings:api-model")
include(":components:server-settings:backend")
include(":components:snippet-findings:api-model")
include(":components:snippet-findings:backend")
...
include(":dao")
include(":logaccess")
include(":logaccess:elasticsearch")
...
dependencyResolutionManagement {
    ...
    versionCatalogs {
        ...
        create("ortLibs") {
            from("org.ossreviewtoolkit:version-catalog:92.6.0")
        }
    }
}
